...
class Dash extends Base
{
    ...
    public $rules = array(
        ...
        'mdash' => array(
            'description' => 'Тире после кавычек, скобок, пунктуации',
            'pattern' => array(
        ...
        'mdash_3' => array(
            'description' => 'Тире после знаков восклицания, многоточия и т.д.',
        ...
        'to_libo_nibud' => array(
            'description' => 'Автоматическая подстановка дефисов в обезличенных местоимениях и междометиях',
            'cycled' => true,
